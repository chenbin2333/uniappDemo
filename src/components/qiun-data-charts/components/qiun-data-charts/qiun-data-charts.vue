...
export default {
  ...
  methods: {
    ...
    _touchStart(e) {
      ...
      this.emitMsg({
        name: 'getTouchStart',
        params: { type: 'touchStart', event: e.changedTouches[0], id: cid, opts: cfu.instance[cid].opts }
      })
    },
    _touchMove(e) {
      let cid = this.cid
      ...
      this.emitMsg({
        name: 'getTouchMove',
        params: { type: 'touchMove', event: e.changedTouches[0], id: cid, opts: cfu.instance[cid].opts }
      })
    },
    _touchEnd(e) {
      let cid = this.cid
      ...
      this.emitMsg({
        name: 'getTouchEnd',
        params: { type: 'touchEnd', event: e.changedTouches[0], id: cid, opts: cfu.instance[cid].opts }
      })
      if (this.ontap === true && cfu.option[cid].enableScroll === false && this.onmovetip === true) {
        this._tap(e, true)
      }
